    ...
    private void processCheckout(Session s, Transaction tr, User user, Address address, JsonObject responseObject) {
        try {
            ...
            for (Cart cart : cartList) {
                ...
                if (address.getCity().getName().equals("colombo")) {
            ...
            // Generate invoice PDF after payment completion
            responseObject.addProperty("invoiceUrl", "InvoiceServlet?orderId=" + orderId);
